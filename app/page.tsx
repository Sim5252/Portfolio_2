...
export default function Home() {
  return (
    ...
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gray-900 text-white flex justify-center items-center">
    ...
    <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800 flex justify-center items-center" id="about">
      <div className="container px-4 md:px-6">
